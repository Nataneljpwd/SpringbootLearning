...
import { faEraser, faFillDrip, faPaintbrush, faRedo, faUndo } from "@fortawesome/free-solid-svg-icons";
...
export default function CanvasOptions(){
    ...
    return (
        <div style = {{background:"linear-gradient(50deg, "+ state.color +", "+ getInverseColor(state.color) +")",
